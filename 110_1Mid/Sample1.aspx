...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/eye-slash-solid.svg" Height="30" Width="30" /><br />
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/youtube-brands.svg" Height="30px" Width="30px">HyperLink</asp:HyperLink><br />
            <asp:Label ID="Label5" runat="server" Text="驗證碼" Font-Size="X-Large">
            </asp:Label><asp:TextBox ID="tb_Num" runat="server" Height="15px" Width="50px"></asp:TextBox>
            <asp:TextBox ID="ig_Num" runat="server" Height="15px" Width="50px" BackColor="#0099FF" /><br />
            <asp:Button ID="btn_Submit" runat="server" Text="送出" Height="30px" Width="80px" /><br />
